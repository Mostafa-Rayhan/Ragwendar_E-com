        ...
        <div className="row p-0 m-0">
            ...
            <div className="card p-3 pb-0 cardMedia mb-2">
                ...
                <div className="prod-row">
                    ...
                    <span
                        ...
                        >Ice Water Blue Half Sleeve T-shirt</a
                        ></span
                    >
                    <div className="vq3wCE45Mr1b clearfix">
                        <span className="nCO9izgeR4DFi5JOQSiMUfkaYFW9qhpE9RF3gpleowQ"><b>₹</b>349</span
                        ><span className="AS6Jdr40MwTS">₹799</span>
                    </div>
                    <div className="Ad6f">You saved ₹450!</div>
                    ...
                    <a aria-current="false" href="p/plain-half-sleeves-t-shirt-men-blue-114?src=cart"
                        ><img
                        src="https://images.bewakoof.com/t320/ice-water-blue-half-sleeve-t-shirt-men-s-plain-t-shirts-315183-1617628301.jpg"
                        title="Ice Water Blue Half Sleeve T-shirt"
                        alt="Ice Water Blue Half Sleeve T-shirt"
                    /></a>
                    </div>
                </div>
                </div>
            ...
            <div className="card cardMedia">
                ...
                <div className="row container">
                    ...
                    <div className="summary_text">₹ 549</div>
                    </div>
                    <div className="d-flex justify-content-between p-2">
                    <div className="summary_text">Beyoung Discount</div>
                    <div className="summary_text">- ₹ 190</div>
                    </div>
                    <div className="d-flex justify-content-between p-2">
